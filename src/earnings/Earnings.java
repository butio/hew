...
public class Earnings {
	...
	public static SimpleDateFormat nowdate = new SimpleDateFormat("yyyy-MM-dd");
	public static String strdate = (nowdate.format(cl.getTime()));
